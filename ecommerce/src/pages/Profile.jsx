...
export default function Profile() {
    ...
    // States matching the backend User model
    ...
    return (
        <motion.div 
            className="max-w-xl mx-auto p-8 mt-8 bg-white border border-slate-100 shadow-sm rounded-2xl"
        ...
        >
            ...
            <div className="flex flex-col gap-5">
                ...
                <div>
                    ...
                    <input 
                        className="w-full p-3 border border-slate-200 outline-none rounded-xl bg-slate-100 text-slate-500 cursor-not-allowed" 
                        value={user?.email || ''} 
                        disabled 
                    />
                </div>
                ...
                <button 
                    ...
                    disabled={loading}
                    className="w-full p-4 mt-2 font-bold text-white transition shadow-md bg-indigo-600 rounded-xl hover:bg-indigo-700 disabled:bg-slate-400"
                >
